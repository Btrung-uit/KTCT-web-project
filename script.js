...
let content = fs.readFileSync('scratch.tsx', 'utf8');

const branch_group_code = 
...
const desktop_view_start = content.indexOf('/* DESKTOP VIEW (Pan / Zoom Canvas) */');
const footer_start = content.indexOf('{/* FOOTER CTA */}');

const desktop_code = /* DESKTOP VIEW (Pan / Zoom Canvas) */
          <div 
...
const new_content = content.substring(0, desktop_view_start) + desktop_code + content.substring(footer_start);

fs.writeFileSync('src/pages/MindMap.tsx', new_content, 'utf8');
